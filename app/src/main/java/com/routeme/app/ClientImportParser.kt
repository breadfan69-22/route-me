...
object ClientImportParser {
    ...
    private val IMPORT_CLIENT_BUILD_CONFIG = CsvParsingUtils.ClientBuildConfig(
        ...
        lawnSizeKeys = listOf("lawnsize", "lawn_size", "lawn size", "sqft", "square_feet"),
        sunShadeKeys = listOf("sunshade", "sun_shade", "sun shade", "sun/shade"),
        terrainKeys = listOf("terrain", "slope", "slopes", "steep_slopes"),
        windExposureKeys = listOf("windexposure", "wind_exposure", "wind exposure"),
